...
export default function Toolbar({ editor }: Readonly<{ editor: Editor }>) {
	...
	return (
		<div className={`border-b border-gray-100 pb-4 mb-6 transition-all duration-300 ease-in-out ${
			editorState.isFocused ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0 overflow-hidden pb-0 mb-0'
		}`}>
